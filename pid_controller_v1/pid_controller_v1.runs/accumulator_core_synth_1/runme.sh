...
HD_PWD='D:/my/Vivado/pid_controller_v1/pid_controller_v1.runs/accumulator_core_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log accumulator_core.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source accumulator_core.tcl
