...
HD_PWD='D:/my/Vivado/pid_controller_v1/pid_controller_v1.runs/adder_core_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adder_core.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adder_core.tcl
