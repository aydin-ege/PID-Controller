...
HD_PWD='C:/Users/ahmet/Desktop/test_code/test_code.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_top_module.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_top_module.tcl
