...
HD_PWD='C:/Users/ahmet/Desktop/test_code/test_code.runs/PID_controller_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PID_controller_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PID_controller_0.tcl
