...
HD_PWD='C:/Users/ahmet/Desktop/test_code/test_code.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_top_module.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_top_module.tcl -notrace
