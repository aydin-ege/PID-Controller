...
#
# Generated by export_simulation on Mon Jan 18 16:20:26 +0300 2021
#
################################################################################
...
switch to the './PID_controller_0.sh' script.

./PID_controller_0.sh -reset_run
...
./PID_controller_0.sh -noclean_files

For more information on the script, please type './PID_controller_0.sh -help'.
